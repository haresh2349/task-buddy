...
export const BoardTaskCard = ({ todo,index }:{todo:Todo,index:number}) => {
  ...
  return (
    <>
      <div ref={setRefs} className={`task ${isDragging ? 'dragging' : ''} w-full min-h-[80px] md:min-h-[120px] lg:min-h-[150px] relative p-4 bg-white rounded-lg shadow-[rgba(100,100,111,0.2)_0px_7px_29px_0px] hover:shadow-md transition-shadow cursor-move`}>
