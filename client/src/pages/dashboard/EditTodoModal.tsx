...
export const EditTodoModal = ({ isOpen, onClose }: CreateTodoModalProps) => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`rounded bg-[#FFF] z-1 w-[80%] md:w-[40%] h-[${
            fetchLoading ? "550px" : "auto"
          }] rounded-xl shadow-[rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset]`}
        >
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="date"
                    value={
                      changedDetails?.dueDate || changedDetails?.dueDate === ""
