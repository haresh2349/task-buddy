...
export const updateTodoItem = async (params: UpdateTodoParams) => {
    try {
        ...
        if (params.updates.description !== undefined) updateObj.description = params.updates.description;
        if (params.updates.dueDate !== undefined) updateObj.dueDate = params.updates.dueDate;
